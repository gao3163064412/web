    ...
    <el-row :gutter="20">
      ...
      <el-col :xs="18" :sm="18" :md="18" :lg="20" :xl="20">
        <el-form
          ...
          :inline="true"
          v-show="showSearch"
          class="top form_label_auto searchFormBox"
        >
          ...
          >
            <template slot-scope="scope">
              ...
              <!-- <el-button
                ...
                size="mini"
                type="text"
                icon="el-icon-delete" style="color: #FF6D8A;"
...
import uploadImg from "../../../components/ImageUpload/index";
export default {
  name: "User",
...
::v-deep {
  .el-form--inline .el-form-item--medium .el-form-item__content {
    width: auto;
  }
}
</style>
